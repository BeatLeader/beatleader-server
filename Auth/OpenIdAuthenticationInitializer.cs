...
public class SteamTicketAuthenticationInitializer<TOptions, THandler> : IPostConfigureOptions<TOptions>
    ...
    where THandler : SteamTicketAuthenticationHandler<TOptions>
{
    ...
    /// </summary>
    public SteamTicketAuthenticationInitializer(IDataProtectionProvider dataProtectionProvider)
    {
