...
public partial class BeatLeaderAuthenticationHandler : OAuthHandler<BeatLeaderAuthenticationOptions>
{
    public BeatLeaderAuthenticationHandler(
        [NotNull] IOptionsMonitor<BeatLeaderAuthenticationOptions> options,
