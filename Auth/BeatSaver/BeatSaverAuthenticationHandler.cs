...
public partial class BeatSaverAuthenticationHandler : OAuthHandler<BeatSaverAuthenticationOptions>
{
    public BeatSaverAuthenticationHandler(
        [NotNull] IOptionsMonitor<BeatSaverAuthenticationOptions> options,
