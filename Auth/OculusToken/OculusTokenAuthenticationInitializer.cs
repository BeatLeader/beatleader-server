...
public class OculusTokenAuthenticationInitializer<TOptions, THandler> : IPostConfigureOptions<TOptions>
    ...
    where THandler : OculusTokenAuthenticationHandler<TOptions>
{
    ...
    /// </summary>
    public OculusTokenAuthenticationInitializer(IDataProtectionProvider dataProtectionProvider)
    {
