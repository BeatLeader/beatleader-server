...
public class PasswordAuthenticationInitializer<TOptions, THandler> : IPostConfigureOptions<TOptions>
    ...
    where THandler : PasswordAuthenticationHandler<TOptions>
{
    ...
    /// </summary>
    public PasswordAuthenticationInitializer(IDataProtectionProvider dataProtectionProvider)
    {
