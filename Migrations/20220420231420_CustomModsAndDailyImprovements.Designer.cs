...
namespace BeatLeader_Server.Migrations
{
    ...
    [Migration("20220420231420_CustomModsAndDailyImprovements")]
    partial class CustomModsAndDailyImprovements
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeatLeader_Server.Models.Clan", b =>
                {
                    ...
                    b.Property<int>("AverageAccuracy")
                        .HasColumnType("int");

                    b.Property<int>("AverageRank")
                        .HasColumnType("int");

                    b.Property<string>("BannedClanId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("ClanRequestId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("BannedClanId");

                    b.HasIndex("ClanRequestId");
            ...
            modelBuilder.Entity("BeatLeader_Server.Models.Clan", b =>
                {
                    b.HasOne("BeatLeader_Server.Models.User", null)
                        .WithMany("BannedClans")
                        .HasForeignKey("BannedClanId");

                    b.HasOne("BeatLeader_Server.Models.User", null)
                        .WithMany("ClanRequest")
            ...
            modelBuilder.Entity("BeatLeader_Server.Models.User", b =>
                {
                    b.Navigation("BannedClans");

                    b.Navigation("ClanRequest");
