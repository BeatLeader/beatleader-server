...
namespace BeatLeader_Server.Migrations
{
    ...
    [Migration("20231228215001_NewCurve")]
    partial class NewCurve
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeatLeader_Server.Models.CurvePoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FSRatingId")
                        .HasColumnType("int");

                    b.Property<int?>("SFRatingId")
                        .HasColumnType("int");

                    b.Property<int?>("SSRatingId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FSRatingId");

                    b.HasIndex("SFRatingId");

                    b.HasIndex("SSRatingId");
            ...
            modelBuilder.Entity("BeatLeader_Server.Models.DifficultyDescription", b =>
                {
                    ...
                    b.Property<float?>("PatternRating")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("BeatLeader_Server.Models.LeaderboardChange", b =>
                {
                    ...
                    b.Property<float>("NewLinearRating")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("NewPatternRating")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("OldLinearRating")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("OldPatternRating")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("BeatLeader_Server.Models.CurvePoint", b =>
                {
                    ...
                    b.HasOne("BeatLeader_Server.Models.ModifiersRating", null)
                        .WithMany("FSCurve")
                        .HasForeignKey("FSRatingId");

                    b.HasOne("BeatLeader_Server.Models.ModifiersRating", null)
                        .WithMany("SFCurve")
                        .HasForeignKey("SFRatingId");

                    b.HasOne("BeatLeader_Server.Models.ModifiersRating", null)
                        .WithMany("SSCurve")
                        .HasForeignKey("SSRatingId");
                });
            ...
            modelBuilder.Entity("BeatLeader_Server.Models.ModifiersRating", b =>
                {
                    b.Navigation("FSCurve");

                    b.Navigation("SFCurve");

                    b.Navigation("SSCurve");
                });
