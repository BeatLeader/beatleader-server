...
namespace BeatLeader_Server.Controllers
{
    ...
    public class PlaylistController : Controller
    {
            ...
            [FromQuery] bool duplicate_diffs = false)
        {
            ...
            int searchCount = 0;
            sequence = sequence.Filter(_readAppContext, out List<SongMetadata> matches, sortBy, order, search, type, mode, mapType, allTypes, mapRequirements, allRequirements, mytype, stars_from, stars_to, accrating_from, accrating_to, passrating_from, passrating_to, techrating_from, techrating_to, date_from, date_to, currentID);
